...
export default function Cart() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-200 font-sans text-sm font-bold w-full">
      <Nav />
      <div className="card w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden ">
        <div className="flex flex-wrap border border-white">
          ...
          {/* Summary Section */}
          <div className="w-full md:w-1/3 bg-gray-300 p-5">
            ...
            <form className="my-4">
              ...
              <select className="w-full border p-2 bg-gray-200">
